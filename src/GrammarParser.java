// $ANTLR 3.5.2 Grammar.g 2018-05-22 17:57:59
...
public class GrammarParser extends Parser {
	...
	// $ANTLR start "atom"
	// Grammar.g:106:1: atom : ( INT | BOOL | IDF ^ ( ( callFun ) )? | block -> ^( ANOBLOCK block ) | 'input' '(' STRING ')' -> ^( 'input' STRING ) | '(' expr ')' -> expr );
	public final GrammarParser.atom_return atom() throws RecognitionException {
		...
		try {
			// Grammar.g:106:6: ( INT | BOOL | IDF ^ ( ( callFun ) )? | block -> ^( ANOBLOCK block ) | 'input' '(' STRING ')' -> ^( 'input' STRING ) | '(' expr ')' -> expr )
			int alt42=6;
			switch ( input.LA(1) ) {
			case INT:
				{
			...
			switch (alt42) {
				...
				case 4 :
					...
					break;
				case 5 :
					// Grammar.g:110:2: 'input' '(' STRING ')'
					{
					string_literal138=(Token)match(input,47,FOLLOW_47_in_atom912);  
					stream_47.add(string_literal138);

					char_literal139=(Token)match(input,33,FOLLOW_33_in_atom914);  
					stream_33.add(char_literal139);

					STRING140=(Token)match(input,STRING,FOLLOW_STRING_in_atom916);  
					stream_STRING.add(STRING140);

					char_literal141=(Token)match(input,34,FOLLOW_34_in_atom918);  
				...
				case 6 :
					...
					{
					char_literal142=(Token)match(input,33,FOLLOW_33_in_atom930);  
					...
					char_literal144=(Token)match(input,34,FOLLOW_34_in_atom932);  
		...
		try {
			...
			switch (alt46) {
				case 1 :
					...
					{
					string_literal145=(Token)match(input,55,FOLLOW_55_in_expr944);  
					stream_55.add(string_literal145);

					char_literal146=(Token)match(input,UNAIRE,FOLLOW_UNAIRE_in_expr946);  
					stream_UNAIRE.add(char_literal146);

					char_literal147=(Token)match(input,40,FOLLOW_40_in_expr948);  
					...
					while (true) {
						...
						case 1 :
							...
							{
							char_literal149=(Token)match(input,35,FOLLOW_35_in_expr952);  
					...
					char_literal151=(Token)match(input,41,FOLLOW_41_in_expr958);  
				...
				case 2 :
					...
					{
					string_literal152=(Token)match(input,51,FOLLOW_51_in_expr970);  
					stream_51.add(string_literal152);

					char_literal153=(Token)match(input,UNAIRE,FOLLOW_UNAIRE_in_expr972);  
					stream_UNAIRE.add(char_literal153);

					char_literal154=(Token)match(input,33,FOLLOW_33_in_expr974);  
					stream_33.add(char_literal154);

					pushFollow(FOLLOW_exS_in_expr976);
					exS155=exS();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							char_literal156=(Token)match(input,35,FOLLOW_35_in_expr980);  
							stream_35.add(char_literal156);

							pushFollow(FOLLOW_exS_in_expr982);
							exS157=exS();
							state._fsp--;
					...
					char_literal158=(Token)match(input,34,FOLLOW_34_in_expr986);  
				...
				case 3 :
					...
					{
					string_literal159=(Token)match(input,52,FOLLOW_52_in_expr998);  
					stream_52.add(string_literal159);

					char_literal160=(Token)match(input,UNAIRE,FOLLOW_UNAIRE_in_expr1000);  
					stream_UNAIRE.add(char_literal160);

					char_literal161=(Token)match(input,33,FOLLOW_33_in_expr1002);  
					stream_33.add(char_literal161);

					pushFollow(FOLLOW_exS_in_expr1004);
					exS162=exS();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							char_literal163=(Token)match(input,35,FOLLOW_35_in_expr1007);  
							stream_35.add(char_literal163);

							pushFollow(FOLLOW_exS_in_expr1009);
							exS164=exS();
							state._fsp--;
					...
					char_literal165=(Token)match(input,34,FOLLOW_34_in_expr1013);  
		...
		try {
			...
			switch (alt65) {
				...
				case 4 :
					...
					pushFollow(FOLLOW_bigbinExpr1_in_bigExpr1363);
		...
		try {
			...
			switch (alt67) {
				case 1 :
					...
					INT231=(Token)match(input,INT,FOLLOW_INT_in_bigatom1371); 
				...
				case 2 :
					...
					BOOL232=(Token)match(input,BOOL,FOLLOW_BOOL_in_bigatom1375); 
				...
				case 3 :
					...
					IDF233=(Token)match(input,IDF,FOLLOW_IDF_in_bigatom1380); 
					...
					switch (alt66) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_newStruc_in_bigatom1384);
						...
						case 2 :
							...
							{
							pushFollow(FOLLOW_callFun_in_bigatom1386);
							callFun235=callFun();
							state._fsp--;
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_block_in_bigatom1392);
					block236=block();
					state._fsp--;
				...
				case 5 :
					...
					{
					string_literal237=(Token)match(input,47,FOLLOW_47_in_bigatom1403);  
					stream_47.add(string_literal237);

					char_literal238=(Token)match(input,33,FOLLOW_33_in_bigatom1405);  
					stream_33.add(char_literal238);

					STRING239=(Token)match(input,STRING,FOLLOW_STRING_in_bigatom1407);  
					stream_STRING.add(STRING239);

					char_literal240=(Token)match(input,34,FOLLOW_34_in_bigatom1409);  
	...
	public static final BitSet FOLLOW_47_in_atom912 = new BitSet(new long[]{0x0000000200000000L});
	public static final BitSet FOLLOW_33_in_atom914 = new BitSet(new long[]{0x0000000004000000L});
	public static final BitSet FOLLOW_STRING_in_atom916 = new BitSet(new long[]{0x0000000400000000L});
	public static final BitSet FOLLOW_34_in_atom918 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_atom930 = new BitSet(new long[]{0x029880021A02A200L});
	...
	public static final BitSet FOLLOW_55_in_expr944 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_UNAIRE_in_expr946 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_40_in_expr948 = new BitSet(new long[]{0x029880021A02A200L});
	public static final BitSet FOLLOW_expr_in_expr950 = new BitSet(new long[]{0x0000020800000000L});
	public static final BitSet FOLLOW_35_in_expr952 = new BitSet(new long[]{0x029880021A02A200L});
	public static final BitSet FOLLOW_expr_in_expr954 = new BitSet(new long[]{0x0000020800000000L});
	public static final BitSet FOLLOW_41_in_expr958 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_51_in_expr970 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_UNAIRE_in_expr972 = new BitSet(new long[]{0x0000000200000000L});
	public static final BitSet FOLLOW_33_in_expr974 = new BitSet(new long[]{0x029880021E02A200L});
	public static final BitSet FOLLOW_exS_in_expr976 = new BitSet(new long[]{0x0000000C00000000L});
	public static final BitSet FOLLOW_35_in_expr980 = new BitSet(new long[]{0x029880021E02A200L});
	public static final BitSet FOLLOW_exS_in_expr982 = new BitSet(new long[]{0x0000000C00000000L});
	public static final BitSet FOLLOW_34_in_expr986 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_52_in_expr998 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_UNAIRE_in_expr1000 = new BitSet(new long[]{0x0000000200000000L});
	public static final BitSet FOLLOW_33_in_expr1002 = new BitSet(new long[]{0x029880021E02A200L});
	public static final BitSet FOLLOW_exS_in_expr1004 = new BitSet(new long[]{0x0000000C00000000L});
	public static final BitSet FOLLOW_35_in_expr1007 = new BitSet(new long[]{0x029880021E02A200L});
	public static final BitSet FOLLOW_exS_in_expr1009 = new BitSet(new long[]{0x0000000C00000000L});
	public static final BitSet FOLLOW_34_in_expr1013 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_EQUAL_in_bigbinExpr11049 = new BitSet(new long[]{0x020080021A02A200L});
	...
	public static final BitSet FOLLOW_ORBOOL_in_bigbinExpr21065 = new BitSet(new long[]{0x020080021A02A200L});
	...
	public static final BitSet FOLLOW_ANDBOOL_in_bigbinExpr31080 = new BitSet(new long[]{0x020080021A02A200L});
	...
	public static final BitSet FOLLOW_PREV_in_bigbinExpr41097 = new BitSet(new long[]{0x020080021A02A200L});
	public static final BitSet FOLLOW_OPBOOLEQ_in_bigbinExpr41100 = new BitSet(new long[]{0x020080021A02A200L});
	public static final BitSet FOLLOW_NEXT_in_bigbinExpr41103 = new BitSet(new long[]{0x020080021A02A200L});
	...
	public static final BitSet FOLLOW_set_in_bigbinExpr51120 = new BitSet(new long[]{0x020080021A02A200L});
	...
	public static final BitSet FOLLOW_STAR_in_bigbinExpr61142 = new BitSet(new long[]{0x020080021A02A200L});
	public static final BitSet FOLLOW_DIV_in_bigbinExpr61145 = new BitSet(new long[]{0x020080021A02A200L});
	...
	public static final BitSet FOLLOW_STAR_in_bigstarExpr1181 = new BitSet(new long[]{0x0200800208028200L});
	...
	public static final BitSet FOLLOW_SUB_in_bigmoinsExpr1208 = new BitSet(new long[]{0x0200800208028200L});
	...
	public static final BitSet FOLLOW_UNAIRE_in_bigunExpr1261 = new BitSet(new long[]{0x020080020A028200L});
	public static final BitSet FOLLOW_EPERLU_in_bigunExpr1264 = new BitSet(new long[]{0x020080020A028200L});
	...
	public static final BitSet FOLLOW_bigbinExpr1_in_bigExpr1363 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_bigatom1371 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BOOL_in_bigatom1375 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDF_in_bigatom1380 = new BitSet(new long[]{0x0200000200000002L});
	public static final BitSet FOLLOW_newStruc_in_bigatom1384 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_callFun_in_bigatom1386 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_block_in_bigatom1392 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_47_in_bigatom1403 = new BitSet(new long[]{0x0000000200000000L});
	public static final BitSet FOLLOW_33_in_bigatom1405 = new BitSet(new long[]{0x0000000004000000L});
	public static final BitSet FOLLOW_STRING_in_bigatom1407 = new BitSet(new long[]{0x0000000400000000L});
	public static final BitSet FOLLOW_34_in_bigatom1409 = new BitSet(new long[]{0x0000000000000002L});
